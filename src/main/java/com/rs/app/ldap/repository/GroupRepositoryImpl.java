...
public class GroupRepositoryImpl implements GroupRepoExtension, BaseLdapNameAware {
	...
	public List<String> getAllGroupNames() {
		LdapQuery query = LdapQueryBuilder.query().attributes("cn").where("objectclass").is("groupOfUniqueNames");
